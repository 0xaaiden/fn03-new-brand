    ...
    91409: function (e, t, i) {
      ...
      function w(e) {
        ...
        return (
          ...
          (0, a.jsx)(r.E.div, {
            ...
            onMouseLeave: f,
            className:
              "group pointer-events-none relative flex aspect-[4/3] h-full shrink-0 overflow-hidden rounded-lg bg-[#FBFBFB] bg-cover after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:border after:border-[rgba(0,0,0,0.08)] md:pointer-events-auto ",
            animate: c,
      ...
      function E() {
        ...
        return (0, a.jsx)(r.E.section, {
          style: { x: t },
          className:
            "hidden h-[calc(100vh-505.5px)] max-h-[452px] min-h-[310px] space-x-8 pb-8 md:flex",
          children: C.map((e, t) =>
            (0, a.jsx)(
              w,
